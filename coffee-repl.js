...
(function() {
  var Foo, autocomplete, dir, getPropertys, include, space, suggest, type, _eval;
  ...
  console.assert(_eval("do->window") === window, "_eval");
  ...
  console.assert(type(document.body) === "node", "type node");
